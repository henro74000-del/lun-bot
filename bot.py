...
def check_if_realtor(raw_html, clean_text, title=""):
    ...
    # 1. Вирізаємо фрази-протигази (де ВЛАСНИКИ просять рієлторів не дзвонити)
...
def run_hunter():
    ...
    log(f"🔎 Сканування v8.6... В базі є {initial_db_size} об'єктів.")
...
class SimpleHTTPRequestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write("Бот v8.6 активовано!".encode("utf-8"))
...
if __name__ == "__main__":
    ...
    log(f"🚀 Запуск сервера v8.6 на порту {PORT}...")
